 ...
 */
final class Version20240919100151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sources ADD CONSTRAINT FK_D25D65F2ACE9C349 FOREIGN KEY (translations_id) REFERENCES translations (id)');
