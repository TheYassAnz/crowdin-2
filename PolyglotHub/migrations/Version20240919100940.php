 ...
 */
final class Version20240919100940 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE translations ADD CONSTRAINT FK_C6B7DA87166D1F9C FOREIGN KEY (project_id) REFERENCES sources (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
